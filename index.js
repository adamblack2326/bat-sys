...
client.on('ready', () => {
  ...
  client.user.setStatus('dnd');///dnd/online/streaming
  let status = [`𝖡𝗒 adam`,`${prefix}help`];
  setInterval(()=>{
...
const owner = ["859172971919048785","791265722356465677"]///owner id
const supportServer = "https://discord.gg/ACahnfcv"///server support
const help_info_color = ""///color in help
const color = ""//main color
const moreInfo = `Need more info? use ${prefix}help`
const line = "https://cdn.discordapp.com/attachments/1034088817654779995/1035844224698036254/line.png"///url line link
const صح = "✅";//react
const غلط = "❌";//react
...
message.lineReply(`
> \`-\` **My Link :** https://discord.gg/8pUJgNpjvW
...
client.on("channelCreate", wanted => {
  if(wanted.parentID == "1035618865402630235") {
    setTimeout(() => {
...
.setTitle("> \`#\` **Prices for : boosts** ")
        ...
        .setDescription(`
        \`*1\` **__2boost 3 Month__ (__100k__)**  

        \`*2\` **__1boost 3 Month__ (__150k__)** 
  ...
  if (message.content === "insta") {
    ...
    message.lineReplyNoMention(
      ...
      .setTitle("> \`#\`**Prices for : instagram**")
        .setDescription(`
        \`*1\` **__100 follower__ (__10k__)**  

        \`*2\` **__200 follower__ (__20k__)** 

        \`*3\` **__500 follower__ (__50k__)** 

        \`*4\` **__1000 follower__ (__100k__)** 
    ...
    message.lineReplyNoMention(
      new Discord.MessageEmbed()
       .setTitle("> \`#\`    **Prices for : Tik Tok** ")
        ...
        \`*1\` **__25 followers __** = (**__10k__**)   

        \`*2\` **__50 followers __** = (**__42k__**)   

        \`*3\` **__100 followers __** = (**__90k__**)   

        \`*4\` **__200 followers __** = (**__140k__**)

        \`*5\` **__500 followers __** = (**__200k__**) 

        \`*6\` **__1000 followers __** = (**__250k__**)          
**=============================**
...
client.on('message', message => {
  if (message.content === "nitro") {
    ...
    message.lineReplyNoMention(
      ...
      \`*1\` **__3month Gaming__ ( __90k__**)

      \`*2\` **__1month Gaming__ ( __1.1m__**)       

      \`*3\` **__1month Classic__ ( __140k__**)      
...
///PS Store up by Wanted and Mor3eb
